...
use crate::game_server::{
    ...
    packets::{
        attack_cruiser::{
            ...
            AttackCruiserGameWaveConfig, AttackCruiserGlobalConfig, AttackCruiserHostility,
            AttackCruiserHudMessageConfig, AttackCruiserOpCode, AttackCruiserPlanetConfig,
            AttackCruiserPlayerConfig, AttackCruiserPlayerState, AttackCruiserPlayerStateUnknown1,
            AttackCruiserShipConfig, AttackCruiserShipWeaponConfig, AttackCruiserSpawnConfig,
            AttackCruiserUpdateGameState, AttackCruiserVec, AttackCruiserWaveActorConfig,
            AttackCruiserWaveConfig, AttackCruiserWaveHudMessageConfig,
    ...
    vec![
        GamePacket::serialize(&TunneledPacket {
            ...
            inner: AttackCruiserClientConfig {
                ...
                config1: AttackCruiserConfig::new(
                ...
                config2: AttackCruiserConfig::new(
                    "game config value".to_string(),
                    AttackCruiserConfigDefinition::Game(Box::new(AttackCruiserGameConfig {
                        id: 27001,
                        encounter_id: 0,
                        sound_id: 2413,
                ...
                config3: AttackCruiserConfig::new(
                ...
                configs: vec![
                    AttackCruiserConfig::new(
                        ...
                        AttackCruiserConfigDefinition::ComplexPhysics(Box::new(
                    ...
                    AttackCruiserConfig::new(
                        ...
                        AttackCruiserConfigDefinition::Ship(Box::new(AttackCruiserShipConfig {
                    ...
                    AttackCruiserConfig::new(
                        "player weapon bay config value".to_string(),
                        AttackCruiserConfigDefinition::Blaster(Box::new(
                    ...
                    AttackCruiserConfig::new(
                        ...
                        AttackCruiserConfigDefinition::Camera(Box::new(
