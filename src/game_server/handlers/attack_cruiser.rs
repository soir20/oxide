...
use crate::game_server::{
    ...
    packets::{
        attack_cruiser::{
            ...
            AttackCruiserComplexPhysicsGear, AttackCruiserConfigPlayer,
            ...
            AttackCruiserPlanetConfig, AttackCruiserPlayerConfig,
        ...
        Ok(vec![
            ...
            GamePacket::serialize(&TunneledPacket {
                ...
                inner: AttackCruiserConfigPlayer {
                    ...
                    config1: None,
                    config2: None,
                    config3: Some(AttackCruiserStartupConfig::new(
