...
use crate::game_server::{
    ...
    packets::{
        attack_cruiser::{
            ...
            AttackCruiserActorPoolConfig, AttackCruiserBasePhysicsConfig, AttackCruiserBool,
            ...
            AttackCruiserPlanetConfig, AttackCruiserPlayerConfig, AttackCruiserShipConfig,
                    ...
                    AttackCruiserStartupConfigDefinition::Game(Box::new(AttackCruiserGameConfig {
                        ...
                        players: AttackCruiserVec(
                            ...
                            vec![AttackCruiserPlayerConfig {
                                ship_config: AttackCruiserStartupConfigReference {
                                    class: AttackCruiserStartupConfigClass::Ship,
                                    name: "ship config value".to_string(),
                                },
                                camera_config: AttackCruiserStartupConfigReference {
                                    class: AttackCruiserStartupConfigClass::Camera,
