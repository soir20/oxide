...
#[derive(Clone, Copy, IntoPrimitive, SerializePacket, Deserialize)]
#[repr(u32)]
pub enum NotificationIconId {
    None = 0,
    RepublicDefenderEnergy = 1,
    First = 2,
    Second = 3,
    Third = 4,
    Fourth = 5,
    ...
    BlasterTraining = 14,
    CardCommander = 15,
    CrystalAttunement = 16,
    DailyHolocron = 17,
    DailySpin = 18,
    DailyTrivia = 19,
    LargeDroidProgramming = 20,
    DroidProgramming = 21,
    ForcePerception = 22,
    Infiltration = 23,
    CrisisZiro = 24,
    ...
    RocketRescue = 28,
    SaberStrike = 29,
    SpeederBikeRacing = 30,
    StarFighter = 31,
    StarTyper = 32,
    StuntGungan = 33,
    SpookyChestMask = 34,
    DailyScrambleLifeDay = 35,
    GeonosisCampaign = 36,
    Transport = 37,
    RylothCampaign = 38,
    ForceConnection = 39,
